...
const featuredEvents: EventType[] = [
  {
    ...
    attendees: 120,
    image: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800&auhref=format&fit=crop"
  },
  {
    id: "2",
    ...
    attendees: 350,
    image: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&auhref=format&fit=crop"
  },
  {
    id: "3",
    ...
    attendees: 45,
    image: "https://images.unsplash.com/photo-1526378800651-c32d3ce2b826?w=800&auhref=format&fit=crop"
  }
];
...
const popularGroups: GroupType[] = [
  {
    ...
    members: 87,
    category: "Technology",
    image: "https://images.unsplash.com/photo-1510511233900-1982d92bd835?w=800&auhref=format&fit=crop"
  },
  {
    id: "2",
    ...
    image: "https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=800&auhref=format&fit=crop"
  },
  {
    id: "3",
    ...
    members: 54,
    category: "Arts",
    image: "https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=800&auhref=format&fit=crop"
  }
];
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/events" className="text-primary hover:text-primary/80 flex items-center">
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/groups" className="text-primary hover:text-primary/80 flex items-center">
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/jobs" className="text-primary hover:text-primary/80 flex items-center">
